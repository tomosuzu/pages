...
また、開発する際に対象の要件がこういう仕様だという思い込みも
...
また、別のプラクティスであるTrunkベース開発（ブランチを作らない開発管理手法）をやりやすくなります。
...
ローテーションすることで、ペアの属人化が防げますし、知識の伝搬、関係性の構築にも効果的です。
...
### 常にペアプログラミングしているととても辛そうですが、楽しいことはありますか？
